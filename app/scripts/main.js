...
$.extend(true, $.fn.dataTable.defaults, {
  ...
  "fnInitComplete": function (oSettings, json) {
    ...
    if (currentId) {
      ...
      thisLengthLabel.addClass('control-label col-xs-12 col-sm-12 col-md-8').attr('for', currentId + '_length_select').css('text-align', 'left');
      thisLengthSelect.addClass('form-control input-sm').attr('id', currentId + '_length_select');
      thisLengthSelect.prependTo(thisLength).wrap('<div class="col-xs-12 col-sm-12 col-md-4" />');
